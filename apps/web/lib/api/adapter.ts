...
export interface FrameFactoryAdapter {
  ...
  saveWebpageVideoPilotFeedback(runId: string, feedback: WebpageVideoPilotFeedbackSaveRequest, idempotencyKey: string): Promise<ApiResult<WebpageVideoPilotFeedback>>;
